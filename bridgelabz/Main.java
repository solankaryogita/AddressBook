...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println();
            System.out.print("Please choose a menu item above by entering a number (1-8): ");
            validInput = false;
            ...
            int menuChoice = Integer.parseInt(crudeMenuChoice);
            switch (menuChoice) {
                case 1: addressBook.next();
                    break;
                case 2: addressBook.previous();
                    break;
                case 3: menuSystem.displayAddContactMenu();
                    contact = new Contact();
                    System.out.println();
                ...
                case 4: menuSystem.displayDeleteContactMenu();
                    yesOrNo = in.nextLine();
                    if (yesOrNo.toLowerCase().equals("y"))
                    addressBook.deleteContact();
                    break;
                case 5: menuSystem.displayUpdateContactMenu();
                    String crudeUpdateInfo = in.nextLine();
                    if (crudeUpdateInfo.contains(","))
                    addressBook.updateContact(crudeUpdateInfo.substring(0, crudeUpdateInfo.indexOf(",")), crudeUpdateInfo
                                    .substring(crudeUpdateInfo.indexOf(",") + 1, crudeUpdateInfo.length()));
                else
                    ...
                    break;
                break;
                case 6: menuSystem.displayNumberOfContactsMenu();
                    ...
                    if (!repeat.equals(null))
                    break;
                case 7: menuSystem.displaySearchForContactMenu();
                    ...
                    break;
                case 8: menuSystem.displayQuitApplicationMenu();
                    yesOrNo = in.nextLine();
                    if (yesOrNo.toLowerCase().equals("y")) {
                        System.out.println();
